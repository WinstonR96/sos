...
public class PoliticaUso extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItem nav_item2 = menuNav.findItem(R.id.politica_de_uso);
        nav_item2.setEnabled(false);
    }

    public void showDialog() {
        android.app.AlertDialog.Builder dialogo1 = new android.app.AlertDialog.Builder(PoliticaUso.this);
        ...
        dialogo1.setPositiveButton("SI", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo1, int id) {
                ...
                editor.commit();
                Intent i = new Intent(PoliticaUso.this, LoginActivity.class);
    ...
    private void ComprobarPermisosCamara() {
        int permissionCheck = ContextCompat.checkSelfPermission(PoliticaUso.this,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
                ...
                Intent intent = new Intent(PoliticaUso.this, SimpleScannerActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (id == R.id.escanear) {
            startActivity(new Intent(PoliticaUso.this, Main.class));
        }

//        if(id==R.id.politica_de_uso){
//            startActivity(new Intent(PoliticaUso.this, PoliticaUso.class));
//        }
...
//            return true;
            startActivity(new Intent(PoliticaUso.this, Soporte.class));
        }
